...
> **ESP32-WROOM-32 驅動** ｜ 1.3" 一體化 OLED 面板 ｜ LR7843 MOSFET (靜音)
> **2S 鋰電 Type-C 架構** — 整合式顯示面板、極簡配線、專業視覺。
...
> 💡 **v3.3 升級重點**：
> 1. 採用 **OLED+編碼器一體化模組**：將螢幕與旋鈕整合在同一塊 PCB 上，大幅簡化面板開孔與配線，外觀更專業。
> 2. 靜音化驅動：維持 **LR7843 MOSFET** 配置，實現全機運作無聲。
> 3. 專業電力系統：Type-C 升壓充電 + 2S BMS + 30K/10K 分壓電量監控，顯示精確到 0.1V。
