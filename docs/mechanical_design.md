# 📐 冰滴咖啡機 - 機構設計與零件尺寸 v8 (v3.0 硬體)

> **ESP32-WROOM-32 核心** ｜ **1.3" OLED (I2C)** ｜ 佈水器均勻佈水 ｜ 三通+單向閥×3
...
| 1.3" OLED 模組 | 35 × 34 × 4 | ~8g | SH1106 / I2C 介面 |
...
> [!TIP]
> **佈置策略**：切換為 1.3" OLED 後，由於它是矩形且較薄，建議與 ESP32 平行放置。KY-040 模組因自帶 PCB，建議直立安裝於泵頭側邊，方便手動旋轉。I2C 接線僅需 4 根，會讓內部空間看起來更乾淨。
